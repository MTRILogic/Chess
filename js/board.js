...
export class ChessBoard {
  ...
  getValidMovesForPiece(row, col) {
    ...
    // Special handling for the king to properly check castling conditions
    if (piece.type === PIECES.KING) {
      // Provide the board object to the king's getValidMoves method
      // This allows checking for attacks on the squares the king passes through
      let moves = piece.getValidMoves(this, { row, col });
      return moves;
    } else {
